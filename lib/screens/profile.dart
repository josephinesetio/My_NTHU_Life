...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double productivityVal = _totalTasks > 0 ? ((_completedTasks / _totalTasks) * 100) : 0.0;
                      ...
                      SizedBox(
                        ...
                        child: RadarChart(
                          RadarChartData(
                            ...
                            dataSets: [
                              RadarDataSet(
                                fillColor: const Color(0xFF7C3AED).withOpacity(0.2),
                            ...
                            getTitle: (index, angle) {
                              switch (index) {
                                ...
                                case 1:
                                  return RadarChartTitle(text: 'Productivity ⚡', angle: angle);
                                case 2:
                                  return RadarChartTitle(text: 'Intelligence 🧠', angle: angle);
                                case 3:
                                  return RadarChartTitle(text: 'Ambition 🎯', angle: angle);
                                default:
